    ...
    <nav class="navbar navbar-expand-lg navbar navbar navbar-dark bg-light">
        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active">
                <a class="nav-link text-dark" href="login.php">Login 
        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active">
                <a class="nav-link text-dark" href="register.php">Register 
                <span class="sr-only">(current)</span></a>
    ...
    <div class="container d-flex justify-content-center ">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                aria-describedby="emailHelp" placeholder="Masukkan Alamat Email Anda">
            </div>

            <div class="form-group">
                <label for="inputAddress">No. Handphone</label>
                <input type="text" class="form-control" id="hp" name="nohp" 
            ...
            <div class="card text-center">
                <button type="submit" class="btn justify-content-center btn-primary" 
