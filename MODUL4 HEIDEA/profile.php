...
<html lang="en">
    ...
    <body>
    <nav class="navbar navbar-expand-lg navbar navbar navbar-dark bg-<?= $navbar; ?> navbar-<?= $navbar; ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav font-weight-bold ml-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown mr-4">
                    <a class="nav-link dropdown-toggle font-weight-normal text-dark" 
    ...
    <form action="" method="POST">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                name="email" value="<?= $profile_show['email']; ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Isi Nama Anda" value="<?= $profile_show['nama']; ?>">
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-primary btn-block" name="update">Submit</button>
            <a href="profil.php" class="btn btn-light text-primary btn-block" role="button" aria-pressed="true">Cancel</a>
    </form>
        </div>
