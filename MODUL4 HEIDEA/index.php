    ...
    <nav class="navbar navbar-expand-lg navbar navbar navbar-dark bg-light">
        ...
        <div class="container mt-3">
            ...
            <div class="card-group mb-2">
                <div class="card">
                    <img src="images/yuja.jpeg" class="card-img-top" alt="Yuja Niacin">
                    <div class="card-body">
                        <h5 class="card-title">YUJA NIACIN 30 DAYS BLEMISH CARE SERUM</h5>
                        <p class="card-text">Produk terbaru dari somebymi yang memiliki manfaat 
                        untuk Whitening + blemish care + Anti-wrinkle, sangat recomended untuk 
                        masalah kulit kusam, kulit kering dan berkas jerawat atau FLEK hitam</p>
                        <hr>
                        <h6>Rp169.000</h6>
                    </div>
                ...
                <div class="card">
                    <img src="images/some by mi.jpeg" class="card-img-top" alt="Snail Truecica">
                    <div class="card-body">
                        <h5 class="card-title">SOMEBYMI Snail Truecica Miracle Repair Cream</h5>
                        <p class="card-text">Sebagai pelembap, krim ini mampu memberikan kelembapan 
                        yang menyeluruh dan tahan lama bagi kulit, sehingga terasa halus, lembap dan kenyal. 
                ...
                <div class="card">
                    <img src="images/some by mi toner.jpeg" class="card-img-top" alt="Miracle Toner">
                    <div class="card-body">
                        <h5 class="card-title">30 DAYS MIRACLE TONER</h5>
                        <p class="card-text">Dengan kandungan AHA, BHA, dan PHA bekerja secara efektif 
                        untuk membuat kulit lebih bersih dan lebih bersinar, mengandung 10.000 ppm ekstrak 
                        pohon teh alami secara efektif meningkatkan elastisitas dan menutrisi kulit Anda 
